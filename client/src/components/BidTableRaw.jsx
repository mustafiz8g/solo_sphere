...
const BidTableRaw = ({ bid , handleStatusChange}) => {
        ...
        <tr>
            ...
            <td className='px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap'>
                <div
                    ...
                    ${status === 'Pending' && 'bg-blue-100/60'}
                    ${status === 'In Progress' && 'bg-yellow-100/60'}
                    ${status === 'Complete' && 'bg-green-100/60'}
                    ${status === 'Rejected' && 'bg-red-100/60'}
                        `}
                >
                    <span
